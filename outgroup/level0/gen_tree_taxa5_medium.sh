...
# no outgroup (((Q:0.6,R:0.6):1,L:1.6):0.4,(G:0.8,C:0.8):1.2);
    for((i=$start;i<=$end;++i))
#    for i in 1 2
      do
         ...
         printf ' -tm <C:C_0;G:G_0;L:L_0;Q:Q_0;R:R_0;Z:Z_0> -truenet "((((Q:0.6,R:0.6):1,L:1.6):0.4,(G:0.8,C:0.8):1.2):10,Z:12);" -out "' >> $outfile
