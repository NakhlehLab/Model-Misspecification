...
# no outgroup (((Q:1.5,R:1.5):2.5,L:4):1,(G:2,C:2):3);
# (((Q_0:1.5,R_0:1.5):2.5,L_0:4):1,(G_0:2,C_0:2):3);
    for((i=$start;i<=$end;++i))
#    for i in 1 2
      do
         ...
         printf ' -tm <C:C_0;G:G_0;L:L_0;Q:Q_0;R:R_0;Z:Z_0> -truenet "((((Q:1.5,R:1.5):2.5,L:4):1,(G:2,C:2):3):10,Z:15);" -out "' >> $outfile
