...
# no outgroup (((Q:0.3,R:0.3)I3:0.5,L:0.8)I1:0.2,(G:0.4,C:0.4)I2:0.6)I0;
#
    for((i=$start;i<=$end;++i))
      do
         ...
         printf ' -tm <C:C_0;G:G_0;L:L_0;Q:Q_0;R:R_0;Z:Z_0> -truenet "((((Q:0.3,R:0.3)I3:0.5,L:0.8)I1:0.2,(G:0.4,C:0.4)I2:0.6)I0:10,Z:11);" -out "' >> $outfile
