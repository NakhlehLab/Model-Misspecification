...
# locus_length=2000
quarnet_results <- read.csv(file = '/Users/zhen/Desktop/Zhen/research/phylogenetics/X2/data/simulation/scale_ingroup_half_popsize/net0/new_res_comp/quarnetGoF_iq_summary.csv', header = TRUE, check.names = TRUE)
quarnet_results_true <- read.csv(file = '/Users/zhen/Desktop/Zhen/research/phylogenetics/X2/data/simulation/scale_ingroup_half_popsize/net0/quarnetGoF_true_summary.csv', header = TRUE, check.names = TRUE)

quarnet_results_500<-quarnet_results[quarnet_results$locus_length == 500, ]
quarnet_results_2000<-quarnet_results[quarnet_results$locus_length == 2000, ]
...
ggsave(paste0("/Users/zhen/Desktop/Zhen/research/phylogenetics/X2/data/simulation/scale_ingroup_half_popsize/net0/new_res_comp/quarnet_summary_pval",".pdf"), units = "mm", height = 200, width = 300)
