...
D3_plot <- D3_plot + annotate('text', label = '6%', x = 1, y = 0.022, size = 6)
D3_plot <- D3_plot + annotate('text', label = '10%', x = 2, y = 0.027, size = 6)
D3_plot <- D3_plot + annotate('text', label = '49%', x = 3, y = 0.034, size = 6)
D3_plot <- D3_plot + annotate('text', label = '94%', x = 4, y = 0.044, size = 6)
