...
#D3_gamma_bootstrap_results <- read.csv(file = '/Users/zhen/Desktop/Zhen/research/phylogenetics/X2/data/simulation/scale_ingroup_half_popsize/net0/D3_res.csv', header = TRUE, check.names = TRUE)
D3_gamma_bootstrap_results <- read.csv(file="/Users/zhen/Desktop/Zhen/research/phylogenetics/X2/tools/D3_introgression/D3_res_gamma_0.csv")
### P value calculcation for individual sims ### 

D3_gamma_bootstrap_results<-D3_gamma_bootstrap_results[D3_gamma_bootstrap_results$locus_length == 500, ]
...
#D3_hist_short<-hist(D3_gamma_bootstrap_results[D3_gamma_bootstrap_results$scale == "short", ]$D3_pvals) 
...
ggsave("/Users/zhen/Desktop/Zhen/research/phylogenetics/X2/data/simulation/scale_ingroup_half_popsize/net0/D3_500.pdf", units = "mm", height = 50, width = 200)
