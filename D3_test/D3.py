...
def compute_D3_2stage(marker_path, locus_length):
...
def compute_D3(marker_path, locus_length):
    with open(marker_path, "r") as handle:
        D3_list = {"A":[], "B":[], "C":[], "D3": [], "D3_mean": [], "D3_stdev":[], "D3_pval": []}
        seqs_list = {}
        INGROUP_SPECIES.sort()
...
if __name__ == "__main__":
    ...
    compute_D3(sys.argv[1], int(sys.argv[2]))
    compute_D3_2stage(sys.argv[1], int(sys.argv[2]))
